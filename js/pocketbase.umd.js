!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module ? (module.exports = e()) : "function" == typeof define && define.amd ? define(e) : ((t = "undefined" != typeof globalThis ? globalThis : t || self).PocketBase = e());
})(this, function () {
  "use strict";
  var t = function (e, n) {
      return (
      ...
      s = (function (t) {
          function i(e) {
              var n,
                  o = this;
              return (
                  ((o = t.call(this, "ClientResponseError") || this).url = ""),
                  (o.status = 0),
                  (o.data = {}),
                  (o.isAbort = !1),
                  (o.originalError = null),
                  Object.setPrototypeOf(o, i.prototype),
                  e instanceof i || (o.originalError = e),
                  null !== e && "object" == typeof e && ((o.url = "string" == typeof e.url ? e.url : ""), (o.status = "number" == typeof e.status ? e.status : 0), (o.data = null !== e.data && "object" == typeof e.data ? e.data : {})),
                  "undefined" != typeof DOMException && e instanceof DOMException && (o.isAbort = !0),
                  (o.name = "ClientResponseError " + o.status),
                  (o.message = (null === (n = o.data) || void 0 === n ? void 0 : n.message) || "Something went wrong while processing your request."),
                  o
              );
          }
          return (
  ...
  function u(t, e, n) {
      ...
      if ((i.httpOnly && (s += "; HttpOnly"), i.secure && (s += "; Secure"), i.priority))
  ...
  var h = (function () {
      ...
      p = (function (t) {
          ...
          return (
              ...
              (n.prototype.load = function (e) {
                  ...
                  (this["@collectionId"] = void 0 !== e["@collectionId"] ? e["@collectionId"] : ""),
                      (this["@collectionName"] = void 0 !== e["@collectionName"] ? e["@collectionName"] : ""),
          ...
          return (
              ...
              (n.prototype.load = function (e) {
                  t.prototype.load.call(this, e),
                      ...
                      (this.lastResetSentAt = "string" == typeof e.lastResetSentAt ? e.lastResetSentAt : ""),
                      (this.lastVerificationSentAt = "string" == typeof e.lastVerificationSentAt ? e.lastVerificationSentAt : ""),
                      (this.profile = e.profile ? new p(e.profile) : null);
              }),
              n
          );
      })(h),
      ...
      m = (function (t) {
          ...
          return (
              e(n, t),
              Object.defineProperty(n.prototype, "token", {
                  get: function () {
              ...
              (n.prototype.save = function (e, n) {
                  this._storageSet(this.storageKey, { token: e, model: n }), t.prototype.save.call(this, e, n);
              }),
          ...
          (function () {
              ...
              return (
                  ...
                  (t.prototype.exportToCookie = function (t, e) {
                      var n, i, o;
                      void 0 === e && (e = y);
                      var r = { secure: !0, sameSite: !0, httpOnly: !0, path: "/" },
                          s = d(this.token);
                      (null == s ? void 0 : s.exp) ? (r.expires = new Date(1e3 * s.exp)) : (r.expires = new Date("1970-01-01")), (t = Object.assign({}, r, t));
                      var a = { token: this.token, model: (null === (n = this.model) || void 0 === n ? void 0 : n.export()) || null },
                          l = u(e, JSON.stringify(a), t),
                          c = "undefined" != typeof Blob ? new Blob([l]).size : l.length;
                      return (
                          a.model &&
                              c > 4096 &&
                              ((a.model = { id: null === (i = null == a ? void 0 : a.model) || void 0 === i ? void 0 : i.id, email: null === (o = null == a ? void 0 : a.model) || void 0 === o ? void 0 : o.email }),
                              this.model instanceof f && (a.model.verified = this.model.verified),
                              (l = u(e, JSON.stringify(a), t))),
                          l
                      );
                  }),
      ...
      g = (function (t) {
          ...
          return (
              ...
              (n.prototype.getAll = function (t) {
                  return (
                      void 0 === t && (t = {}),
                      this.client.send("/api/settings", { method: "GET", params: t }).then(function (t) {
                          return t || {};
                      })
                  );
              }),
              (n.prototype.update = function (t, e) {
                  return (
                      void 0 === t && (t = {}),
                      void 0 === e && (e = {}),
                      this.client.send("/api/settings", { method: "PATCH", params: e, body: t }).then(function (t) {
                          return t || {};
                      })
                  );
              }),
              (n.prototype.testS3 = function (t) {
                  return (
                      void 0 === t && (t = {}),
                      this.client.send("/api/settings/test/s3", { method: "POST", params: t }).then(function () {
                          return !0;
                      })
                  );
              }),
      ...
      S = (function (t) {
          ...
          return (
                      ...
                      a = function (u) {
                          return i(r, void 0, void 0, function () {
                              return o(this, function (i) {
                                  return [
                                      2,
                                      this._getList(t, u, e, n).then(function (t) {
                                          var e = t,
                                              n = e.items,
                                              i = e.totalItems;
              ...
              (n.prototype._getOne = function (t, e, n) {
                  ...
                  return (
                      void 0 === n && (n = {}),
                      this.client.send(t + "/" + encodeURIComponent(e), { method: "GET", params: n }).then(function (t) {
                          return i.decode(t);
                      })
                  );
              }),
              (n.prototype._create = function (t, e, n) {
                  ...
                  return (
                      void 0 === e && (e = {}),
                      void 0 === n && (n = {}),
                      this.client.send(t, { method: "POST", params: n, body: e }).then(function (t) {
                          return i.decode(t);
                      })
                  );
              }),
              (n.prototype._update = function (t, e, n, i) {
                  ...
                  return (
                      void 0 === n && (n = {}),
                      void 0 === i && (i = {}),
                      this.client.send(t + "/" + encodeURIComponent(e), { method: "PATCH", params: i, body: n }).then(function (t) {
                          return o.decode(t);
                      })
                  );
              }),
              (n.prototype._delete = function (t, e, n) {
                  return (
                      void 0 === n && (n = {}),
                      this.client.send(t + "/" + encodeURIComponent(e), { method: "DELETE", params: n }).then(function () {
                          return !0;
                      })
                  );
              }),
      ...
      C = (function (t) {
          ...
          return (
              ...
              (n.prototype.authResponse = function (t) {
                  ...
                  return (null == t ? void 0 : t.token) && (null == t ? void 0 : t.admin) && this.client.authStore.save(t.token, e), Object.assign({}, t, { token: (null == t ? void 0 : t.token) || "", admin: e });
              }),
              (n.prototype.authViaEmail = function (t, e, n, i) {
                  return (
                      ...
                      this.client.send(this.baseCrudPath() + "/auth-via-email", { method: "POST", params: i, body: n, headers: { Authorization: "" } }).then(this.authResponse.bind(this))
                  );
              }),
              (n.prototype.refresh = function (t, e) {
                  return void 0 === t && (t = {}), void 0 === e && (e = {}), this.client.send(this.baseCrudPath() + "/refresh", { method: "POST", params: e, body: t }).then(this.authResponse.bind(this));
              }),
              (n.prototype.requestPasswordReset = function (t, e, n) {
                  return (
                      ...
                      this.client.send(this.baseCrudPath() + "/request-password-reset", { method: "POST", params: n, body: e }).then(function () {
                          return !0;
                      })
                  );
              }),
              (n.prototype.confirmPasswordReset = function (t, e, n, i, o) {
                  return (
                      ...
                      this.client.send(this.baseCrudPath() + "/confirm-password-reset", { method: "POST", params: o, body: i }).then(this.authResponse.bind(this))
                  );
              }),
              n
          );
      ...
      P = (function (t) {
          ...
          return (
              ...
              (n.prototype.load = function (e) {
                  t.prototype.load.call(this, e),
                      (this.userId = "string" == typeof e.userId ? e.userId : ""),
                      (this.provider = "string" == typeof e.provider ? e.provider : ""),
                      (this.providerId = "string" == typeof e.providerId ? e.providerId : "");
              }),
              n
          );
      })(h),
      j = (function (t) {
          ...
          return (
              ...
              (n.prototype.authResponse = function (t) {
                  ...
                  return (null == t ? void 0 : t.token) && (null == t ? void 0 : t.user) && this.client.authStore.save(t.token, e), Object.assign({}, t, { token: (null == t ? void 0 : t.token) || "", user: e });
              }),
              (n.prototype.listAuthMethods = function (t) {
                  return (
                      void 0 === t && (t = {}),
                      this.client.send(this.baseCrudPath() + "/auth-methods", { method: "GET", params: t }).then(function (t) {
                          return Object.assign({}, t, { emailPassword: !!(null == t ? void 0 : t.emailPassword), authProviders: Array.isArray(null == t ? void 0 : t.authProviders) ? (null == t ? void 0 : t.authProviders) : [] });
                      })
                  );
              }),
              (n.prototype.authViaEmail = function (t, e, n, i) {
              ...
              (n.prototype.authViaOAuth2 = function (t, e, n, i, o, r) {
                  return (
                      void 0 === o && (o = {}),
                      void 0 === r && (r = {}),
                      (o = Object.assign({ provider: t, code: e, codeVerifier: n, redirectUrl: i }, o)),
                      this.client.send(this.baseCrudPath() + "/auth-via-oauth2", { method: "POST", params: r, body: o, headers: { Authorization: "" } }).then(this.authResponse.bind(this))
                  );
              }),
              (n.prototype.refresh = function (t, e) {
                  return void 0 === t && (t = {}), void 0 === e && (e = {}), this.client.send(this.baseCrudPath() + "/refresh", { method: "POST", params: e, body: t }).then(this.authResponse.bind(this));
              ...
              (n.prototype.requestVerification = function (t, e, n) {
                  return (
                      ...
                      void 0 === n && (n = {}),
                      (e = Object.assign({ email: t }, e)),
                      this.client.send(this.baseCrudPath() + "/request-verification", { method: "POST", params: n, body: e }).then(function () {
                          return !0;
                      })
                  );
              }),
              (n.prototype.confirmVerification = function (t, e, n) {
                  return (
                      ...
                      this.client.send(this.baseCrudPath() + "/confirm-verification", { method: "POST", params: n, body: e }).then(this.authResponse.bind(this))
                  );
              }),
              (n.prototype.requestEmailChange = function (t, e, n) {
                  return (
                      ...
                      this.client.send(this.baseCrudPath() + "/request-email-change", { method: "POST", params: n, body: e }).then(function () {
                          return !0;
                      })
                  );
              }),
              (n.prototype.confirmEmailChange = function (t, e, n, i) {
                  return (
                      ...
                      this.client.send(this.baseCrudPath() + "/confirm-email-change", { method: "POST", params: i, body: n }).then(this.authResponse.bind(this))
                  );
              }),
              (n.prototype.listExternalAuths = function (t, e) {
                  return (
                      void 0 === e && (e = {}),
                      this.client.send(this.baseCrudPath() + "/" + encodeURIComponent(t) + "/external-auths", { method: "GET", params: e }).then(function (t) {
                          var e = [];
                          if (Array.isArray(t))
              ...
              (n.prototype.unlinkExternalAuth = function (t, e, n) {
                  return (
                      void 0 === n && (n = {}),
                      this.client.send(this.baseCrudPath() + "/" + encodeURIComponent(t) + "/external-auths/" + encodeURIComponent(e), { method: "DELETE", params: n }).then(function () {
                          return !0;
                      })
                  );
              }),
          ...
          return (
              (t.prototype.load = function (t) {
                  (this.id = void 0 !== t.id ? t.id : ""),
                      ...
                      (this.options = "object" == typeof t.options && null !== t.options ? t.options : {});
              }),
              t
          );
      })(),
          ...
          return (
              ...
              (n.prototype.load = function (e) {
                  t.prototype.load.call(this, e),
                      ...
                      (this.createRule = "string" == typeof e.createRule ? e.createRule : null),
                      (this.updateRule = "string" == typeof e.updateRule ? e.updateRule : null),
                      (this.deleteRule = "string" == typeof e.deleteRule ? e.deleteRule : null),
                  ...
                  return (
                      ...
                      i(this, void 0, void 0, function () {
                          return o(this, function (i) {
                              return [
                                  2,
                                  this.client.send(this.baseCrudPath() + "/import", { method: "PUT", params: n, body: { collections: t, deleteMissing: e } }).then(function () {
                                      return !0;
                                  }),
                              ];
                          });
          ...
          return (
              ...
              (n.prototype.load = function (e) {
                  t.prototype.load.call(this, e),
                      ...
                      (this.remoteIp = "string" == typeof e.remoteIp ? e.remoteIp : ""),
                      (this.userIp = "string" == typeof e.userIp ? e.userIp : ""),
                      (this.referer = "string" == typeof e.referer ? e.referer : ""),
                      (this.userAgent = "string" == typeof e.userAgent ? e.userAgent : ""),
                      (this.meta = "object" == typeof e.meta && null !== e.meta ? e.meta : {});
              }),
              n
          );
      })(h),
          ...
          return (
              ...
              (n.prototype.getRequestsList = function (t, e, n) {
                  return (
                      ...
                      this.client.send("/api/logs/requests", { method: "GET", params: n }).then(function (t) {
                          var e = [];
                          if (null == t ? void 0 : t.items) {
              ...
              (n.prototype.getRequest = function (t, e) {
                  return (
                      void 0 === e && (e = {}),
                      this.client.send("/api/logs/requests/" + encodeURIComponent(t), { method: "GET", params: e }).then(function (t) {
                          return new A(t);
                      })
                  );
              }),
              (n.prototype.getRequestsStats = function (t) {
                  return (
                      void 0 === t && (t = {}),
                      this.client.send("/api/logs/requests/stats", { method: "GET", params: t }).then(function (t) {
                          return t;
                      })
                  );
              }),
                      ...
                      return o(this, function (i) {
                          switch (i.label) {
                              case 0:
                                  ...
                                  return (
                                      this.subscriptions[t] && (null === (n = this.eventSource) || void 0 === n || n.removeEventListener(t, this.subscriptions[t])),
                  ...
                  return i(this, void 0, void 0, function () {
                      return o(this, function (t) {
                          return (
                              ...
                              [
                                  2,
                                  this.client.send("/api/realtime", { method: "POST", body: { clientId: this.clientId, subscriptions: Object.keys(this.subscriptions) }, params: { $autoCancel: !1 } }).then(function () {
                                      return !0;
                                  }),
                              ]
                          );
  ...
  return (function () {
      function t(t, e, n) {
          void 0 === t && (t = "/"),
              ...
              (this.baseUrl = t),
              (this.lang = e),
              (this.authStore = n || new m()),
              (this.admins = new C(this)),
              (this.users = new j(this)),
              (this.records = new I(this)),
              (this.collections = new T(this)),
              (this.logs = new _(this)),
              (this.settings = new g(this)),
              (this.realtime = new x(this));
      }
      return (
          Object.defineProperty(t.prototype, "AuthStore", {
              get: function () {
          ...
          (t.prototype.send = function (t, e) {
              ...
              return i(this, void 0, void 0, function () {
                  ...
                  return o(this, function (S) {
                      return (
                          (f = Object.assign({ method: "GET" }, e)).body &&
                              "FormData" !== f.body.constructor.name &&
                              ("string" != typeof f.body && (f.body = JSON.stringify(f.body)),
                              void 0 === (null === (n = null == f ? void 0 : f.headers) || void 0 === n ? void 0 : n["Content-Type"]) && (f.headers = Object.assign({}, f.headers, { "Content-Type": "application/json" }))),
                          void 0 === (null === (r = null == f ? void 0 : f.headers) || void 0 === r ? void 0 : r["Accept-Language"]) && (f.headers = Object.assign({}, f.headers, { "Accept-Language": this.lang })),
                          (null === (a = this.authStore) || void 0 === a ? void 0 : a.token) &&
                              void 0 === (null === (u = null == f ? void 0 : f.headers) || void 0 === u ? void 0 : u.Authorization) &&
                              ((v = "Admin"),
                              void 0 !== (null === (l = this.authStore.model) || void 0 === l ? void 0 : l.verified) && (v = "User"),
                              (f.headers = Object.assign({}, f.headers, { Authorization: v + " " + this.authStore.token }))),
                          !1 !== (null === (c = f.params) || void 0 === c ? void 0 : c.$autoCancel) &&
                              ((y = (null === (d = f.params) || void 0 === d ? void 0 : d.$cancelKey) || (f.method || "GET") + t),
                              this.cancelRequest(y),
                              (m = new AbortController()),
                              (this.cancelControllers[y] = m),
                              (f.signal = m.signal)),
                          null === (h = f.params) || void 0 === h || delete h.$autoCancel,
                          null === (p = f.params) || void 0 === p || delete p.$cancelKey,
                          (b = this.buildUrl(t)),
                          void 0 !== f.params && ((g = this.serializeQueryParams(f.params)) && (b += (b.includes("?") ? "&" : "?") + g), delete f.params),
                          this.beforeSend && (f = Object.assign({}, this.beforeSend(b, f))),
                          [
                              2,
                              fetch(b, f)
                                  .then(function (t) {
                                          ...
                                          return o(this, function (n) {
                                              switch (n.label) {
                                                  ...
                                                  case 3:
                                                      return n.sent(), [3, 4];
                                                  case 4:
                                                      if ((this.afterSend && (e = this.afterSend(t, e)), t.status >= 400)) throw new s({ url: t.url, status: t.status, data: e });
                                                      return [2, e];
                                              }
                                          });
                                      });
